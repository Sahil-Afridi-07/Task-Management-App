...
const Login = () => {
  ...
  return (
    ...
    >
      <div className="login-container w-96 h-[25rem] bg-white rounded-lg">
        <div className="w-full h-1/4 rounded-t-lg bg-[#dada]">
          ...
          <div className="px-10 pt-3">
            <form action="" onSubmit={handleSubmit} className="flex flex-col">
              ...
              <input
                className="w-full py-2 rounded-md mt-5 bg-green-600 cursor-pointer text-white"
                type="submit"
                value="Login"
              />
            </form>
            <p className="text-center pt-4 text-sm">Don't have a account? <Link to={"/"} className="text-blue-500 font-medium cursor-pointer">Sign up</Link></p>
          </div>
        </div>
      </div>
    </div>
